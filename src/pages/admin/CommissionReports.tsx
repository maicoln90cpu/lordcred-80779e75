      ...
      <div className="space-y-4">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="geral">
            <PlaceholderTab title="Geral" description="Importação de dados de produção do New Corban. Upload de Excel com 17 colunas." />
          </TabsContent>
          <TabsContent value="repasse">
            <PlaceholderTab title="Repasse" description="Importação de dados de repasse/pagamento com 21 colunas." />
          </TabsContent>
          <TabsContent value="seguros">
            <PlaceholderTab title="Seguros" description="Importação de dados de seguros prestamistas com 5 colunas." />
          </TabsContent>
          ...
          <TabsContent value="import_history">
            <PlaceholderTab title="Histórico de Importações" description="Controle de todos os lotes importados com opção de exclusão." />
          </TabsContent>
        </Tabs>
      </div>
    </DashboardLayout>
