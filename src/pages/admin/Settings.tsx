...
export default function Settings() {
  ...
  const handleSaveProvider = async () => {
    ...
    try {
      ...
      toast({ title: 'Configurações do provedor salvas' });
    } catch (error) {
    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">Aquecimento, mensagens, provedores WhatsApp e integrações</p>
        </div>

        <Tabs defaultValue="config" className="space-y-6">
          <TabsList>
            <TabsTrigger value="config">Aquecimento</TabsTrigger>
                  ...
                  <CardContent className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <div className="flex gap-2">
                        ...
                        <Button variant="outline" size="icon" onClick={() => handleCopyWebhook(webhookUrl)}>
