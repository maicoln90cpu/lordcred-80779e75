            ...
            {sim && (
              <section className="space-y-2 border-t pt-3">
                ...
                <FinancialCompositionBlock
                  released={sim.released_value}
                  installment={sim.installment_value}
                  installments={sim.installments}
                  precomputed={{
                    total_paid: sim.total_paid ?? null,
                    total_interest: sim.total_interest ?? null,
                    markup_pct: sim.markup_pct ?? null,
                    cet_monthly_pct: sim.cet_monthly_pct ?? null,
                    cet_annual_pct: sim.cet_annual_pct ?? null,
                  }}
                />
              </section>
            )}
