...
export default function MetaUserAccessCard() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      metaChips.forEach(c => { chipUserMap[c.id] = []; });
      ...
      toast({ title: 'Acessos salvos com sucesso', description: `${enabledUsers.size} vendedor(es) com acesso configurado` });
    } catch (error: any) {
      ...
      <CardHeader>
        ...
        <CardDescription>
          ...
          <span className="flex items-center gap-1 mt-1">
            ...
            Master e Admin sempre têm acesso a todos os chips automaticamente.
          </span>
        </CardDescription>
      </CardHeader>
