  ...
  const handleSave = async () => {
    ...
    try {
      const payload = {
        ...
        min_valor: editing.min_valor ?? 0,
        max_valor: editing.max_valor ?? 999999999,
        taxa: editing.taxa ?? 0,
      };
    ...
    <Card>
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="text-xs text-right">Valor Mín</TableHead>
                  <TableHead className="text-xs text-right">Valor Máx</TableHead>
      ...
      <Dialog open={!!editing} onOpenChange={() => setEditing(null)}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle>{editing?.id ? 'Editar' : 'Nova'} Regra FGTS</DialogTitle>
          </DialogHeader>
          {editing && (
            <div className="grid gap-3">
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <Input value={editing.banco || ''} onChange={e => setEditing(p => ({ ...p!, banco: e.target.value.toUpperCase() }))} placeholder="Ex: MERCANTIL" />
                </div>
              </div>
              <div className="grid grid-cols-2 gap-3">
                <div>
              ...
              <div className="grid grid-cols-3 gap-3">
                <div>
                  ...
                  <Input type="number" value={editing.min_valor ?? 0} onChange={e => setEditing(p => ({ ...p!, min_valor: parseFloat(e.target.value) || 0 }))} />
                </div>
                <div>
                  <label className="text-xs font-medium text-muted-foreground">Valor Máx</label>
                  <Input type="number" value={editing.max_valor ?? 999999999} onChange={e => setEditing(p => ({ ...p!, max_valor: parseFloat(e.target.value) || 999999999 }))} />
                </div>
                <div>
