...
import { ClipboardList, Landmark, TrendingUp, Clock, CheckCircle, AlertTriangle, Wifi, RefreshCw, DollarSign, FileText, Users, Activity } from 'lucide-react';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';
import { Badge } from '@/components/ui/badge';
import { Button } from '@/components/ui/button';
import { useNavigate } from 'react-router-dom';
import { invokeCorban } from '@/lib/invokeCorban';
import { normalizeCorbanPropostasInput } from '@/lib/corbanPropostas';
...
export function CorbanOverviewTab() {
