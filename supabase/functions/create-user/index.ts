...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Only admin and user can create users
    ...
    if (callerRole === 'admin') {
      // Admin (Master) can create: user (Administrador) or seller (Vendedor)
      validRole = role === 'user' ? 'user' : 'seller'
    } else {
      // User (Administrador) can ONLY create sellers
      validRole = 'seller'
    }
