...
BEGIN
  ...
  -- ============================================================
  -- Cascata de matching (V2):
  --   1) specific      = banco + tabela + prazo + valor + seguro
  --   2) generic       = banco + prazo + valor + seguro          (ignora tabela)
  --   3) generic_nv    = banco + prazo + seguro                  (ignora tabela e valor)
  --   4) fallback      = banco + seguro + data                   (paridade V1)
  -- ============================================================
  ...
  IF NEW.product = 'FGTS' THEN
    ...
    -- NOVO nível 3: ignora valor, ainda usa prazo
