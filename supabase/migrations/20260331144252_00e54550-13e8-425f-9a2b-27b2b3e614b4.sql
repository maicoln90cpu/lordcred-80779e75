...
BEGIN
  -- FIX: Convert timestamptz to date in Brazil timezone to avoid UTC date shift
...
-- Recalculate all existing week_labels by re-triggering the function
UPDATE commission_sales SET sale_date = sale_date;
