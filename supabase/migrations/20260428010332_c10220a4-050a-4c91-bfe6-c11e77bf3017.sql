DO $$
BEGIN
  PERFORM cron.unschedule('v8-active-consult-poller-every-minute');
EXCEPTION WHEN OTHERS THEN NULL;
END $$;

SELECT cron.schedule(
  'v8-active-consult-poller-every-minute',
  '* * * * *',
  $$SELECT net.http_post(
    url := 'https://sibfqmzsnftscnlyuwiu.supabase.co/functions/v1/v8-active-consult-poller',
